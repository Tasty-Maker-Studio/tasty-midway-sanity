    ...
    <div className="f x aic rel cart__single">
      ...
      <div>
        ...
        <div className="f jcs aic product__form-qty-wrapper mt05 mxa">
          <button
            className="block rel qty__control no-style s24 f jcc aic founders cursor py05 aic"
            onClick={() =>
          ...
          <input
            ...
            name="quantity"
            min="1"
            className="cb founders card-qty bn ac"
          />
          <button
            className="qty__control no-style s1 block f jcc aic founders s24 cursor rel py05 jcc aic"
        ...
        <button
          type="reset"
          className="p05 abs no-style close right top cb"
